  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-dark">
        <strong><?php echo $rows['MemberName'];?></strong> Wants to Return Books in Library?
      </div>
...
<button type="button" onclick="redirect()" class="btn btn-info ">Back to Home</button>
         </form>
