...
<div class="col-sm-6">
<form action="ReturnBackend.php" method="POST"> 
    <div class="mb-3 own mt-3 text-light"><h2>RETURN-BY</h2></div>
            <div class="mb-3">
  
            <label for="exampleFormControlInput1" class="form-label text-light">MEMBER ID <span class="error">*</span></label><br>
...
<h5 class="text-light"><strong>Search a Books For Return</strong></h5>
</form>
</div>
