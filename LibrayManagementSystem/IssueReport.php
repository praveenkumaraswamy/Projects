...
$sql = "SELECT BookNo,MemberId,Transaction_id,Issuedate,DueDate FROM transaction WHERE ReturnDate IS NULL";
...
echo '<img class="img-fluid img-responsive images" src="Issuerepo.png" height="300px" width="300px">';
    ...
    echo '<thead>';
    echo '<tr>';
    echo '<th class="table-dark" >BookNo</th>';
    echo '<th class="table-dark">MemberId</th>';
    echo '<th class="table-dark" >TransactionId</th>';
    echo '<th class="table-dark">IssueDate</th>';
    echo '<th class="table-dark" >DueDate</th>';
