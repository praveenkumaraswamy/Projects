...
session_start();
   ...
   $sql = "SELECT BookName,BookNo FROM books_inventory";
   ...
   echo '<img class="img-fluid img-responsive images" src="GETTER.png" height="300px" width="300px">';
    echo '<div class="container">';
    echo '<div class="row">';
    echo '<div class="col-10">';
    echo '<div id="okk" class="text-success"><marquee height="" loop="">Total Books List Of Library</marquee></div>';
